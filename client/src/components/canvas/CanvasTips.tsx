...
const PRIORITY_TIPS: Tip[] = [
  ...
  // #301 配音链路一句话能力（#295-#300）：锁音色 + 批量配音口令强曝光。
  { id: "agent-dub", icon: <Sparkles size={15} />, title: "配音也是一句话", body: "对助手说「把陈默的音色锁成温柔女声」锁定角色音色（角色卡出现 🎙 徽标）；再说「给每个镜头配音」逐镜自动配音——锁定音色自动沿用、多角色分音色、已配的镜自动跳过、执行前弹计价确认。" },
