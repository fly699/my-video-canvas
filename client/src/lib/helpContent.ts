...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  // ── 图像生成节点 ────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "h3", text: "模型选择器" },
      { type: "p", text: "点击模型下拉可按供应商 / 家族分组浏览、搜索，每个模型右侧标注预估消耗点数（credits），方便按预算选择。" },
      { type: "p", text: "不同模型的参数（尺寸 / 比例、分辨率、数量 n、输出格式、质量等）会随所选模型自动切换，仅展示该模型支持的项。" },
      { type: "tip", text: "连接上游「提示词」节点后，提示词字段会自动填充。也可以连接「分镜」节点，用分镜描述驱动图像生成；连接图像作参考图即进入图生图 / 编辑模式。" },
    ],
  },
  ...
  // ── 视频任务节点 ────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "p", text: "模型下拉按供应商 / 家族分组、可搜索，每个模型标注预估消耗点数。选定模型后，参数面板（时长 / 分辨率 / 宽高比 / 音频 / 多镜头等）会随模型自动切换，只展示该模型支持的项。" },
      { type: "p", text: "支持「并行对比模式」：一次最多选 3 个模型同时生成，横向比较效果。" },
      { type: "h3", text: "多模态参考（身份/风格一致性）" },
      { type: "p", text: "Seedance 2 等支持参考模式的模型：除参考图外，连接 视频/音频素材 即作 reference_video_urls / reference_audio_urls 多模态参考（参考模式与首尾帧 image_urls 互斥，系统自动按文档对位）。" },
      { type: "h3", text: "角色身份" },
  ...
  // ── 音频节点 ────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "tip", text: "ElevenLabs V3 TTS 按字符计费、音乐生成按次计费，详见模型说明。" },
    ],
  },
