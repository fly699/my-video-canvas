...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  // ── 分镜节点 ────────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: "h3", text: "镜头表（Shot List）" },
      { type: "p", text: "点节点内「镜头表」按钮侧向展开同组分镜的序列总览（同一脚本生成的所有分镜）：镜号/景别/运镜/时长/转场一表统管，行内可编辑、↑↓ 重排、按画布位置重编号；显示总时长 vs 脚本目标时长的偏差，可一键按比例缩放达标；相邻镜「衔接优化」按 180° 轴线/景别递进/运镜动静衔接自动修正。" },
