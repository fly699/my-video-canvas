          ...
          {runState.running && (
            ...
            >
              <div
                style={{
                  height: "100%",
                  width: `${nodes.length > 0 ? Math.round(((runState.completedIds.length + runState.failedIds.length) / nodes.length) * 100) : 0}%`,
                ...
                >
                  {runState.running ? (
                    <>
                      ...
                      运行中 {runState.completedIds.length + runState.failedIds.length}/{nodes.length}
                    </>
                  ) : (
                    <>
