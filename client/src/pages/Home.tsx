              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  // #293 置顶旗舰：画布助手一句话快速成片。
                  {
                    ...
                    title: "画布助手 · 一句话快速成片",
                    desc: "对助手说「做一个雨夜侦探短片，6 镜头，竖屏」——自动写脚本、拆分镜、角色定妆、逐镜建节点连线；生成后「按镜头表装配」自动合成成片，「运行全部」批量生成，「做个动态样片」零成本预览，「把陈默的音色锁成温柔女声」锁角色音色、「给每个镜头配音」逐镜自动配音；📎 参考图定风格/作首帧/锁脸，@角色 / 技能，随时撤销；建/连/改不花钱",
                    badge: "HOT",
                  },
                  {
